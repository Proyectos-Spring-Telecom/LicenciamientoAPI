...
| [contratos.md](./contratos.md) | Contratos HTTP (endpoints, campos multipart, mapeos IdTipoFoto, respuestas GET) |
...
- `src/registros/licencia-construccion.constants.ts` → `LC_FILE_TIPO_FOTO`, `LC_RESPONSE_PHOTO_MAP`
